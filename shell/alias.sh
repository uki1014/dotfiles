...
alias reviewpr='gh pr list --search "review-requested:@me" | fzf | cut -f1 | xargs -I {} gh pr checkout {}'
...
alias keymap='cat ~/dactyl-manuform-trackball/keyboards/handwired/wylderbuilds/trackball/4x5_3_track/keymaps/vial/keymap.c'
alias edit_keymap='nvim ~/dactyl-manuform-trackball/keyboards/handwired/wylderbuilds/trackball/4x5_3_track/keymaps/vial/keymap.c'
...
alias addserena="claude mcp add --scope user serena -- uvx --from git+https://github.com/oraios/serena serena start-mcp-server"
