...
alias puld='git pull -p upstream develop'
alias pulm='git pull -p upstream master'
alias pulma='git pull -p upstream main'
alias pulr='git pull -p --rebase'
alias pulrd='git pull -p --rebase upstream develop'
alias pulrm='git pull -p --rebase upstream master'
alias pulrma='git pull -p --rebase upstream main'
alias pulrod='git pull -p --rebase origin develop'
alias pulrom='git pull -p --rebase origin master'
alias pulroma='git pull -p --rebase origin main'
