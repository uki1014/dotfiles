...
vim.cmd('au BufRead,BufNewFile tsconfig.json setf jsonc')
...
-- fish
vim.cmd('au BufNewFile,BufRead fish_funced setf fish')
...
vim.g.node_host_prog = os.getenv('NODENV_ROOT')..'/versions/12.22.5/bin/neovim-node-host'
